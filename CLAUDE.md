...
## Run Information
- Mayhem Run: mayhemheroes/pocketlang/pocket/2
- Git Commit: 68ae71b3d56a017a77f6b11a7dda0b04a36ddf92
- Original Image: ghcr.io/mayhemheroes/pocketlang:master
- Target Executable: /repo/build/Debug/bin/pocket
- CI URL: https://github.com:443/mayhemheroes/pocketlang/actions/runs/3113340642
...
- Source code: `/rlenv/source/pocketlang/`
...
RUN cp <build-artifact> /repo/build/Debug/bin/pocket

# 11. Permission Management (REQUIRED)
RUN chmod 766 /repo/build/Debug/bin/pocket
...
# 14. Set Entry Point
CMD ["/repo/build/Debug/bin/pocket"]
...
- `COPY . /rlenv/source/pocketlang/` happens early (source exists)
...
- ✅ Must work from `/rlenv/source/pocketlang/`

## Critical Requirements Checklist

### Permissions (REQUIRED)
- [ ] Source directory: `chmod -R 777 /rlenv/source`
- [ ] Target executable: `chmod 766 /repo/build/Debug/bin/pocket`
...
- [ ] Target executable in Dockerfile.rlenv: `/repo/build/Debug/bin/pocket`
- [ ] Target executable in build.sh: `/repo/build/Debug/bin/pocket`
- [ ] Target executable in metadata.json: `/repo/build/Debug/bin/pocket`
- [ ] All must match for validation to work

### COPY Order (REQUIRED)
- [ ] `COPY . /rlenv/source/pocketlang/` - EARLY (source exists now)
...
WORKDIR /rlenv/source/pocketlang/fuzz
...
- Source copy: `COPY . /rlenv/source/pocketlang/`
...
- Working directory: `cd /rlenv/source/pocketlang/`
- No network access
